...
export const TradeBotID = process.env.MOST_PROFITABLE_SOLANA_TRADING_BOT_ID;
...
export const AlertBotID = process.env.MOST_PROFITABLE_SOLANA_TRADING_ALERT_BOT_ID;
